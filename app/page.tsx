        ...
        <main className="flex-1 min-w-0">
          ...
          <header className="flex items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-3">
              <button className="relative w-10 h-10 rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors">
                ...
                <span className="absolute top-2 right-2.5 w-2 h-2 bg-[#10B981] rounded-full border-2 border-white"></span>
              </button>
              <div className="bg-white rounded-2xl px-4 py-2 border border-gray-100 shadow-sm">
                ...
                <p className="text-sm font-bold text-[#10B981]">$5,456</p>
              </div>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button className="rounded-full gap-2 h-10 px-5 bg-[#10B981] hover:bg-[#059669] text-white text-sm font-medium shadow-lg shadow-emerald-500/25">
          ...
          <div className="grid grid-cols-3 gap-5 mb-6">
            {[
              ...
              { label: "Total Visitors", value: "35k", change: -6.2, color: "#10B981", icon: "users" },
              { label: "Total Orders", value: "165k", change: 3.5, color: "#4F46E5", icon: "bag" },
            ].map((stat, i) => (
              <div key={i} className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                <div className="flex items-center gap-4">
                  <div className={cn("w-14 h-14 rounded-full flex items-center justify-center relative", stat.color === "#4F46E5" ? "bg-indigo-50" : "bg-emerald-50")}>
                    <div 
                  ...
                  <div>
                    ...
                    <div className="flex items-baseline gap-2">
                      ...
                      <span className={cn("text-[13px] font-semibold", stat.change > 0 ? "text-[#10B981]" : "text-[#EF4444]")}>
          ...
          <div className="grid grid-cols-5 gap-5">
            ...
            <div className="col-span-3 bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="flex items-center gap-6 mb-6">
                ...
                <div className="text-[#10B981] text-[13px] font-semibold">↑ 15.6%</div>
            ...
            <div className="col-span-2 flex flex-col gap-5">
              {/* Promo Card */}
              <div className="bg-[#10B981] rounded-2xl p-6 text-white relative overflow-hidden h-[160px]">
                ...
                <div className="relative z-10">
                  ...
                  <Button className="bg-white text-[#10B981] hover:bg-white/95 rounded-full gap-2 h-9 px-5 text-[13px] font-semibold shadow-lg">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex-1">
                ...
                <div className="relative h-44 flex items-center justify-center">
                  ...
                  <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-center">
                    ...
                    <div className="flex items-center gap-1 text-[#10B981] text-[13px] font-semibold justify-center">↑ 3.5%</div>
                  </div>
                </div>
